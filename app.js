...
const App = (() => {
  ...
  function paintJ1Performance(panel, allParticipants, j1rows) {
    ...
    const cols = [
      ...
      // Replaced the J1 Program Sources column, which stays as the filter
      // dropdown.
      { label: 'Processing Sponsor', render: p => esc(p.processingSponsor),   sort: p => txtSort(p.processingSponsor) },
